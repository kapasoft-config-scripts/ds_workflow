...
function _default_css($plugin_type)
{
    ...
    drupal_add_css(drupal_get_path('theme', $GLOBALS['theme']) . '/assets/global/plugins/uniform/css/uniform.default.css', array('type' => 'file', 'weight' => CSS_THEME, 'preprocess' => FALSE));
...
//function _default_css_list($plugin_type)
//{
//    $css_list = array();
//    $path_to_theme = drupal_get_path('theme', $GLOBALS['theme']);
//    $css_list[] = array('path'=> $path_to_theme . '/assets/drupal/custom_metronic.css', 'options' => array('type'=>'file','weight'=> CSS_THEME + 4));
////    drupal_add_css(drupal_get_path('theme', $GLOBALS['theme']) . '/assets/drupal/custom_metronic.css', array('type' => 'file', 'weight' => CSS_THEME + 4));
//
//    //BEGIN GLOBAL MANDATORY STYLES -->
//    $css_list[] = array('path'=> $path_to_theme . '/assets/drupal/metronic_fonts.css', 'options' => array('type'=>'file','weight'=> CSS_THEME, 'preprocess' => FALSE));
//    $css_list[] = array('path'=> $path_to_theme . '/assets/global/plugins/font-awesome/css/font-awesome.min.css', 'options' => array('type'=>'file','weight'=> CSS_THEME, 'preprocess' => FALSE));
//    $css_list[] = array('path'=> $path_to_theme . '/assets/global/plugins/simple-line-icons/simple-line-icons.min.css', 'options' => array('type'=>'file','weight'=> CSS_THEME, 'preprocess' => FALSE));
//    $css_list[] = array('path'=> $path_to_theme . '/assets/global/plugins/bootstrap/css/bootstrap.min.css', 'options' => array('type'=>'file','weight'=> CSS_THEME, 'preprocess' => FALSE));
//    $css_list[] = array('path'=> $path_to_theme . '/assets/global/plugins/uniform/css/uniform.default.css', 'options' => array('type'=>'file','weight'=> CSS_THEME, 'preprocess' => FALSE));
...
////<!-- END GLOBAL MANDATORY STYLES -->
//
//    array_merge($css_list,_plugin_css_list($plugin_type));
//
////<!-- BEGIN THEME STYLES -->
//    $css_list[] = array('path'=> $path_to_theme . '/assets/global/css/components.css', 'options' => array('type'=>'file','weight'=> CSS_THEME, 'preprocess' => FALSE));
//    $css_list[] = array('path'=> $path_to_theme . '/assets/global/css/plugins.css', 'options' => array('type'=>'file','weight'=> CSS_THEME, 'preprocess' => FALSE));
//    $css_list[] = array('path'=> $path_to_theme . '/assets/admin/layout/css/layout.css', 'options' => array('type'=>'file','weight'=> CSS_THEME, 'preprocess' => FALSE));
//
//    //determine color
...
//    }
//    $css_list[] = array('path'=> $final_css, 'options' => array('type'=>'file','weight'=> CSS_THEME, 'preprocess' => FALSE));
//    $css_list[] = array('path'=> $path_to_theme . '/assets/admin/layout/css/custom.css', 'options' => array('type'=>'file','weight'=> CSS_THEME, 'preprocess' => FALSE));
//    return $css_list;
//}
...
function metronic_js_alter(&$javascript)
{
    ...
    replace_jquery($javascript, drupal_get_path('theme', $GLOBALS['theme']) . '/assets/global/plugins/jquery-1.11.0.min.js', '1.11.0');
}
