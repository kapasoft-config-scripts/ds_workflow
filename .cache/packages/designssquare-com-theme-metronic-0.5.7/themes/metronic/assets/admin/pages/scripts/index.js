            ...
            if (!$.cookie('intro_show')) {
                setTimeout(function () {
                    var unique_id = $.gritter.add({
                        ...
                        title: '<a href="http://designssquare.com" target="_blank">Get Metronic Drupal Theme Just For 100$</a>',
                        // (string | mandatory) the text inside the notification
                        text: 'Metronic is World\'s #1 Selling Bootstrap 3 Admin Theme Ever! 15400+ Users Can\'t be Wrong.',
                        // (string | optional) the image to display on the left
                        image: BASE_URL + 'sites/default/files/designssquare_com_theme_metronic/assets/admin/layout/img/avatar1.jpg',
                ...
                setTimeout(function () {
                    var unique_id = $.gritter.add({
                        // (string | mandatory) the heading of the notification
                        title: '<a href="http://designssquare.com" target="_blank">Develop with Metronic!</a>',
                        // (string | mandatory) the text inside the notification
