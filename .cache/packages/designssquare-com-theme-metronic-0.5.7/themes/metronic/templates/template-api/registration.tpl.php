...
<div class="form-group">
    ...
    <div class="input-icon">
        ...
        <input class="form-control placeholder-no-fix" type="text" placeholder="Email" name="<?php print $registration_tapi['email_name'];?>"/>
    </div>
</div>
<!--<div class="form-group">-->
...
<div class="form-group">
    ...
    <div class="input-icon">
        ...
        <input class="form-control placeholder-no-fix" type="text" autocomplete="off" placeholder="Username" name="<?php print $registration_tapi['user_name'];?>"/>
    </div>
</div>
<!--<div class="form-group">-->
