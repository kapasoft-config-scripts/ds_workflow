    ...
    <div class="page-content">
        ...
        <div class="col-md-3">
            <ul class="list-unstyled profile-nav">
                <li>
                    <img src="<?php print $user_tapi['profile']['url'] ?>" style="width: <?php print $user_tapi['profile']['width'] ?>px; height: <?php print $user_tapi['profile']['height'] ?>px" class="img-responsive" alt=""/>
        ...
        <div class="tab-pane" id="tab_1_4">
            ...
            <div class="row portfolio-block">
                <div class="col-md-5">
                    <div class="portfolio-text">
                        <img src="/sites/default/files/designssquare_com_theme_metronic/assets/admin/pages/media/profile/logo_metronic.jpg" alt=""/>
            ...
            <div class="row portfolio-block">
                <div class="col-md-5 col-sm-12 portfolio-text">
                    <img src="/sites/default/files/designssquare_com_theme_metronic/assets/admin/pages/media/profile/logo_azteca.jpg" alt=""/>
                    <div class="portfolio-text-info">
                        <h4>Metronic - Responsive Template</h4>
                        <p>
                            Lorem ipsum dolor sit consectetuer adipiscing elit.
            ...
            <div class="row portfolio-block">
                <div class="col-md-5 portfolio-text">
                    <img src="/sites/default/files/designssquare_com_theme_metronic/assets/admin/pages/media/profile/logo_conquer.jpg" alt=""/>
                    <div class="portfolio-text-info">
                        <h4>Metronic - Responsive Template</h4>
                        <p>
                            Lorem ipsum dolor sit consectetuer adipiscing elit.
