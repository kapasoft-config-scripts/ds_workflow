<form id="<?php print $contact_tapi['id'] ?>" action="<?php print $contact_tapi['action'] ?>" method="post">
        ...
        <div class="form-group">
            <div class="input-icon">
                ...
                <input type="text" class="form-control" name="<?php print $contact_tapi['subject_name']?>" placeholder="Subject">
            </div>
        </div>
        <div class="form-group">
            <div class="input-icon">
                <i class="fa fa-user"></i>
                <input type="text" class="form-control" name="<?php print $contact_tapi['name_name'];?>" placeholder="Name">
            </div>
        </div>
        <div class="form-group">
            <div class="input-icon">
                <i class="fa fa-envelope"></i>
                <input type="password" class="form-control" name="<?php print $contact_tapi['email_name']?>" placeholder="Email">
            </div>
        </div>
        <div class="form-group">
            <textarea class="form-control" rows="3=6" name="<?php print $contact_tapi['message_name'] ?>" placeholder="Feedback"></textarea>
        </div>
