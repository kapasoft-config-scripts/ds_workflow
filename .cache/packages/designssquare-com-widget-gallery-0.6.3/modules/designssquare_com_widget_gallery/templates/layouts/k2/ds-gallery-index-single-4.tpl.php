...
?>
<div
    class="contextual-links-region col-md-3 col-sm-4 mix <?php print $gallery_tapi['categories']['flattened_names'] ?>"
    ...
    <div class="mix-inner">
        ...
        <div
            ...
            <div class='preview-links'>
                ...
                <a class="mix-preview fancybox-button preview-link"
                   href="<?php print $gallery_tapi['featured_img']['url'] ?>"
                   title="<a href='<?php print $gallery_tapi['url'] ?>'><?php print $gallery_tapi['title'] ?></a>"
